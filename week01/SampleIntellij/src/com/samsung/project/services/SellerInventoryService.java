...
public class SellerInventoryService extends AbstractService implements ServiceEndpoint<InventoryItem> {
    /**
     * @return
     */
    public String getServiceId() {
        return "SellerInventoryService";
    }
    ...
    public List<InventoryItem> invoke(Map<String, Object> parameters) throws Exception {
        ...
        return new ArrayList<>() {
            {
                add(new InventoryItem("1", "D"));
                add(new InventoryItem("2", "D"));
                add(new InventoryItem("3", "D"));
            }
        };
    }
}
